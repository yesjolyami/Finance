...
- копирует versioned migrations 00001–00005 и pinned goose module;
...
`5`, пять applied versions и пять SQL constraint suites. DSN/password не
...
9. Сделать encrypted backup и выполнить migration procedure до version 5.
